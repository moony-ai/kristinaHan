...
class Order(models.Model):
    ...
    orderStatus = models.CharField(
        max_length=50, choices=ORDER_STATUS_CHOICES, blank=False
    )
    ...
    deliveryMethod = models.CharField(
        max_length=50, choices=DELIVERY_METHOD_CHOICES, blank=False
    )
    ...
    tuxedoType = models.CharField(
        max_length=100, choices=TUXEDO_TYPE_CHOICES, blank=True, null=True
    )
    ...
    dressType = models.CharField(
        max_length=100, choices=DRESS_TYPE_CHOICES, blank=True, null=True
    )
    ...
    necklaceSize = models.CharField(
        max_length=50, choices=NECKLACE_SIZE_CHOICES, blank=True, null=True
    )
    EARRING_TYPE_CHOICES = [
        ("귀찌", "귀찌"),
        ("귀걸이", "귀걸이"),
    ]
    earringType = models.CharField(
        max_length=50, choices=EARRING_TYPE_CHOICES, blank=True, null=True
    )
    ...
    relationToOrderer = models.CharField(
        max_length=50, choices=RELATION_TO_ORDERER_CHOICES, blank=False
    )
    ...
    paymentMethodKRW = models.CharField( # 선수금 결제 방법 - 원화
        max_length=10,
